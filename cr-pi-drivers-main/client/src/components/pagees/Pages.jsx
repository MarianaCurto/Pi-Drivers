...
const Pages = ({totalDrivers, currentPage, setCurrentPage, driversPerPage}) => {
...
let endPage = Math.min(Math.ceil(totalDrivers / driversPerPage), startPage + maxDisplayedPages - 1);
